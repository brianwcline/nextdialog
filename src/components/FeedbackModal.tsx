            ...
            {submitted ? (
              ...
              <>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 py-2 rounded-lg border border-slate-200 bg-white/60 text-slate-800 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-violet-300 placeholder:text-slate-400"
                  autoFocus
                />
